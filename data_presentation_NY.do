capture log close data_presentation_NY
log using "D:\data\kode\FCDY3702\logs\data_presentation_NY.log", replace name(data_presentation_NY)

use  "D:\data\workdata\703702\Data\Sally\data\complete_NY.dta" , replace
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_inpsyk_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_inpsyk_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_insom_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_insom_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_prescpt_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_prescpt_NY.xlsx", sheet("Means",replace) modify
...
local indexcol="``indexcol_no''"
	mean total_DDD, over(year quarter)
		matrix table=(r(table)')
		matrix results=table[1..60,1],table[1..60,5..6]
		putexcel `indexcol'`col'1=matrix(e(N))
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_female_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_female_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_male_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_male_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_before_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_before_NY.xlsx", sheet("Means",replace) modify
...
capture erase "D:\data\workdata\703702\Data\Sally\results\means_DDD_after_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\means_DDD_after_NY.xlsx", sheet("Means",replace) modify
...
label data "Final Long_NY"
save "D:\data\workdata\703702\Data\Sally\data\final_long_NY.dta", replace
...
capture erase "D:\data\workdata\703702\Data\Sally\results\prevalens_NY.xlsx"
putexcel set "D:\data\workdata\703702\Data\Sally\results\prevalens_NY.xlsx", sheet("ALL",replace) modify
local r=2
forvalues i=1995/2012 {
	forvalues j=1/4 {
		tokenize "`c(alpha)'"
...
label data "Final Wide_NY"
save "D:\data\workdata\703702\Data\Sally\data\final_wide_NY.dta", replace

log close data_presentation_NY
